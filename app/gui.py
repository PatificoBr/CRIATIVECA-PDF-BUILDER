...
class PDFBuilderApp(ctk.CTk):
    ...
    def _create_ui(self) -> None:
        ...
        input_label = ctk.CTkLabel(
            input_container, text="📁 Pasta de Imagens:", font=("Helvetica", 12, "bold"))
        ...
        self.input_text = ctk.CTkEntry(
            input_button_frame, placeholder_text="Selecione a pasta com as imagens...")
        ...
        output_label = ctk.CTkLabel(
            output_container, text="💾 Pasta de Saída:", font=("Helvetica", 12, "bold"))
        output_label.pack(anchor="w")

        output_button_frame = ctk.CTkFrame(output_container)
        output_button_frame.pack(fill="x", pady=5)

        self.output_text = ctk.CTkEntry(
            output_button_frame, placeholder_text="Selecione onde salvar o PDF...")
        ...
        ctk.CTkLabel(title_container, text="📘 Título:", font=(
            "Helvetica", 12, "bold")).pack(anchor="w")
        self.title_entry = ctk.CTkEntry(
            title_container, placeholder_text="Digite o título do PDF...")
        ...
        ctk.CTkLabel(subtitle_container, text="📄 Subtítulo:",
                     font=("Helvetica", 12, "bold")).pack(anchor="w")
        self.subtitle_entry = ctk.CTkEntry(
            subtitle_container, placeholder_text="Digite o subtítulo do PDF...")
        ...
        ctk.CTkLabel(filename_container, text="📄 Nome do Arquivo:",
                     font=("Helvetica", 12, "bold")).pack(anchor="w")
        self.filename_entry = ctk.CTkEntry(
            filename_container, placeholder_text="Nome do arquivo (sem .pdf)...")
        self.filename_entry.pack(fill="x", pady=5)

        # Barra de progresso
        progress_label = ctk.CTkLabel(
            main_frame, text="Progresso:", font=("Helvetica", 11, "bold"))
        ...
        self.progress_text = ctk.CTkLabel(
            main_frame, text="0%", font=("Helvetica", 10))
        ...
        log_label = ctk.CTkLabel(
            main_frame, text="📋 Log:", font=("Helvetica", 11, "bold"))
    ...
    def _select_input_folder(self) -> None:
        ...
        if folder:
            ...
            if valid_images:
                ...
                self._log(
                    f"✓ {len(self.selected_images)} imagem(ns) encontrada(s)")
    ...
    def _validate_inputs(self) -> tuple[bool, str]:
        ...
        valid, msg = ImageValidator.validate_pdf_name(
    ...
    def _generate_pdf(self) -> None:
        ...
        if self.is_processing:
            messagebox.showwarning(
                "Aviso", "Já existe uma geração em andamento")
            return
    ...
    def _generate_pdf_thread(self) -> None:
        ...
        try:
            ...
            self._log("\n" + "="*50)
            self._log(
                f"[{datetime.now().strftime('%H:%M:%S')}] Iniciando geração...")
            self._log("="*50)
